...
| colorMin | A hex, rgba, or named color for the minimum value of the range.  Defaults to "#bfe4e7". |
| colorMax | A hex, rgba, or named color for the minimum value of the range.  Defaults to "#00929f".  Also controls dot color for the scatter plot. |
